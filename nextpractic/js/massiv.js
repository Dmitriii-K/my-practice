...
// const massive2 = [...massive]; // второй способ копирования массива Spread
massive2.push(6);
console.log(massive, massive2);

console.log("*** объединение массивов с помощью метода Spread***");
const a = [1, 2, 4];
const b = [3, 5, 8];
const c = [1, 6, 7];
const sum = [...a, ...b, ...c, 23]; // создает новый массив
console.log(sum);
